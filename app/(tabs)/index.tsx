...
export default function Home() {
  ...
  return (
    <View style={{ flex: 1 }}>
      <ImageBackground source={{ uri: data?.[0].attributes.posterImage.original }} resizeMode="cover" style={styles.image}>
        <View
          style={{
            display: "flex",
            flexDirection: "row",
        ...
        <View style={{ backgroundColor: "transparent", paddingLeft: 40, paddingRight: 40, display: "flex", gap: 15 }}>
          <View style={{ backgroundColor: "transparent" }}>
            <Text style={{ color: "white", fontWeight: "bold", fontSize: 24 }}>{data?.[0].attributes.titles.en_jp}</Text>
          </View>
          <View style={{ backgroundColor: "transparent" }}>
            <Text style={{ color: "white", fontWeight: "bold", fontSize: 24 }}>{data?.[0].attributes.ageRatingGuide}</Text>
          </View>
